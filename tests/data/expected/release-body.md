...
- rename the tile cache ([eeeeeee](https://example.com/example/test/commit/eeeeeeeeeeee))

### Features

- **map:** draw migration routes as one line ([aaaaaaa](https://example.com/example/test/commit/aaaaaaaaaaaa))
- **sightings:** filter by species ([bbbbbbb](https://example.com/example/test/commit/bbbbbbbbbbbb))

### Fixes

- **export:** keep the last sighting ([ccccccc](https://example.com/example/test/commit/cccccccccccc))

### Other changes

- **deps:** bump the tile renderer ([ddddddd](https://example.com/example/test/commit/dddddddddddd))
